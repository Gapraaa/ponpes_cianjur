  ...
  <main>
    ...
    <div class="jumbo d-flex justify-content-around" style="background-color: #E2E2E2; padding: 2rem 1rem;">
      <div class="text-center">
        ...
        <p>SMP Ar-Risalah Menjadi Lembaga Pendidikan Menengah formal terdepan yang mencetak <br> cendikia muslim berkarakter islami dan berwawasan internasional</p>
      </div>
      <div class="">
              ...
              <div class="card-body">
                <div class="justify-content-between align-items-center">
                  <svg width="71" height="71" viewBox="0 0 71 71" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <mask id="mask0_38_17" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="4" y="10"
                      width="63" height="57">
                      <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M35.5 11.8334L65.0833 31.0625V65.0834H5.91667V31.0625L35.5 11.8334Z" fill="white"
                      ...
                      <path
                        ...
                        stroke="black" stroke-width="3.25" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M60.6458 65.0834H11.8333" stroke="white" stroke-width="3.25" stroke-linecap="round"
            ...
            <div class="row">
              <div class="col-md-4 mt-3">
                <div class="card" style="margin-left: 60x;">
                  <img src="asset/img/kegiatansmp1.jpg" class="card-img-top" alt="...">
                </div>
              </div>
              <div class="col-md-4 mt-3">
                <div class="card">
                  <img src="asset/img/kegiatansmp2.jpg" class="card-img-top" alt="...">
                </div>
              </div>
              <div class="col-md-4 mt-3">
                <div class="card">
                  <img src="asset/img/kegiatansmp3.jpg" class="card-img-top" alt="...">
                </div>
              </div>
            </div>
          </div>
