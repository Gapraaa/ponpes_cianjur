   ...
   <div class="countainer col-10 mx-auto mb-5 text-center mt-4">
    ...
    <div class="countainer text-center mt-5">
      ...
      <div class="col-10 g-5 mx-auto container mt-5">
        <div class="row row-cols-1 row-cols-sm-1 row-cols-lg-3 row-cols-md-3 g-3">
          <div class="col">
            <div class="card pb-xl-3 pb-md-5">
              <div class="card-body">
                <div class="justify-content-between align-items-center">
                  ...
                  <h5 class="mt-2 mb-3" style="color: #00763A;">Program Billingual (Arab dan Inggris)</h5>
                  <h6 class="mt-2 pb-md-1">Pengembangan kemampuan bahasa Arab dan bahsa Inggris yang intensif di Sekolah.</h6>
                </div>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card pb-xl-1" >
              <div class="card-body">
                <div class="justify-content-between align-items-center">
                  <svg width="71" height="71" viewBox="0 0 71 71" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                  ...
                  <h5 class="mt-2 mb-3" style="color: #00763A;">Pembinaan 4 Jam</h5>
                  <h6 class="mt-2">Siswa akan mendapatkan pendampingan bersama guru-guru berpengalaman selama
                    pembelajaran berlangsung di sekolah maupun diluar sekolah.</h6>
                </div>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card pb-xl-5 pb-md-5" >
              <div class="card-body">
                <div class="justify-content-between align-items-center">
                  <svg width="71" height="71" viewBox="0 0 71 71" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                  ...
                  <h5 class="mt-2 mb-3 mb-md-4 " style="color: #00763A;">Generasi Terwujud</h5>
                  <h6 class="mt-2 pb-xl-2 pb-md-4 m">Terwujudnya generasi yang unggul menuju terbentuknya khaira ummah.</h6>
                </div>
              </div>
            </div>
          </div>
