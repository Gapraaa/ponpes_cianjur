  ...
  <main>
    <div id="carouselExampleCaptions" class="carousel slide mt-5">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active position-relative">
                <img src="{{ asset('asset/img/home paud.jpg') }}" class="d-block w-100 img-fluid" alt="...">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center pt-5 mb-lg-5 mt-lg-5 d-none d-md-block">
                    <h2 class="text-center mt-lg-5">Paud Ar-Risalah</h2>
                    <h5 class="text-center mb-lg-5">Aktif, Kreatif, Efektif, dan Inovatif</h5>
                </div>
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center d-block d-md-none">
                    <small class="text-center "><strong> Paud Ar-Risalah</strong></small>
                    <small class="text-center"><strong> Aktif, Kreatif, Efektif, dan Inovatifmall>
                </div>
            </div>
            <div class="carousel-item position-relative">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center d-block d-md-none">
                    <h6 class="text-center ">Paud Ar-Risalah</h6>
                    <h6 class="text-center ">Aktif, Kreatif, Efektif, dan Inovatif</h6>
                </div>
            </div>
            <div class="carousel-item position-relative">
    ...
    <div class="jumbo d-flex justify-content-around" style="background-color: #E2E2E2; padding: 2rem 1rem;">
        <div class="text-center d-none d-md-block">
            ...
            <p>PAUD Ar-Risalah siap membantu para orang tua untuk menyelamatkan "Usia Emas" putra putrinya.</p>
        </div>
        <div class="text-center d-block d-md-none">
            ...
            <small>PAUD Ar-Risalah siap membantu para orang tua untuk menyelamatkan "Usia Emas" putra putrinya./small>
        </div>
   ...
   <div class="countainer col-10 mx-auto mb-5 text-center mt-4">
            ...
            <div class="container mt-5">
                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-3 row-cols-lg-3 g-lg-5 flex-lg-row">
                    <div class="col mt-5">
                        <div class="card pb-lg-5 pb-md-5 pb-xl-3 " >
                            <div class="card-body">
                                <div class="justify-content-between align-items-center">
                                    ...
                                    <h5 class="mt-3 mb-3 mb-lg-4 mb-md-4">Visi</h5>
                                    <h6 class="d-none d-md-block pb-md-5 pb-lg-5 mb-lg-5">Membentuk anak  yang cerdas, baik <br> dan  terampil berakhlak  mulia, sholeh/sholihah sehingga terwujud anak yang kreatif dan mandiri.
                                    </h6>
                                    <h6 class="d-block d-md-none mb-3">Membentuk anak yang cerdas, baik dan terampil berakhlak mulia, sholeh/sholihah sehingga terwujud anak yang kreatif dan mandiri.
                                    </h6>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col mt-5">
                        <div class="card text-white pb-lg-5 pb-md-4 pb-xl-5  " style="background-color: #00763A;">
                            <div class="card-body">
                                <div class="justify-content-between align-items-center">
                                    ...
                                    <h5 class="mt-3 mb-3 ">Misi</h5>
                                    <h6 class="d-none d-md-block pb-lg-5 mb-lg-3 mb-xl-2 pb-xl-3 pb-md-1">Melaksanakan pembelajaran aktif, kreatif, efektif dan inovatif dan Menyiapkan anak didik ke jenjang pendidikan dasar dengan ketercapaian Kompetensi Dasar sesuai tahapan perkembangan anak.</h6>
                                    <h6 class="d-block d-md-none">Melaksanakan pembelajaran aktif, kreatif, efektif dan inovatif dan Menyiapkan anak didik ke jenjang pendidikan dasar dengan ketercapaian Kompetensi Dasar sesuai tahapan perkembangan anak.</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col mt-5">
                        <div class="card pb-md-2 pb-lg-5 pb-xl-4">
                            <div class="card-body">
                                <div class="justify-content-between align-items-center">
                                    ...
                                    <h5 class="mt-3 mb-3">Tujuan</h5>
                                    <h6 class="d-none d-md-block pb-lg-5 mb-lg-4 pb-xl-5 mb-xl-2">Mengembangkan kurikulum dan perangkat pembelajaran yang inovatif dan Meningkatnya profesionalisme tenaga pendidik dalam mengelola pendidikan yang menyenangkan dan berpotensi serta berkualitas.</h6>
                                        <h6 class="d-block d-md-none mb-3">Mengembangkan kurikulum dan perangkat pembelajaran yang inovatif dan Meningkatnya profesionalisme tenaga pendidik dalam mengelola pendidikan yang menyenangkan dan berpotensi serta berkualitas.</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="d-flex flex-column flex-lg-row align-items-center justify-content-lg-around">
                                        <div class="col-lg-5 text-center text-md-start mt-lg-3 mt-md-0 order-2 order-lg-1 pt-lg-3">
                                            ...
                                            <h6 class="card-text d-none d-lg-block">
                                                Kami memberikan pelayanan pendidikan dengan sepenuh
                                                hati kepada seluruh peserta didik, anak-anak yang kami
                                                cintai sepenuh hati. PAUD Ar-Risalah adalah salah satu
                                                wadah bermain dan belajar bagi anak-anak kita. PAUD Ar-
                                                Risalah siap membantu para orang tua untuk
                                                menyelamatkan “Usia Emas” putra putrinya.
                                                Perencanaan pembelajaran pada program PAUD Ar-Risalah
                                                Segedong sudah disusun dengan matang untuk
                                                memberikan arah yang tepat dalam proses
                                                pembelajarannya dengan mempertimbangkan
    ...
    <div class="countainer text-center mt-5">
      ...
      <div class="col-10 g-5 mx-auto container mt-5">
        <div class="col-10 col-md-12 col-lg-12 g-5 mx-auto container mt-5">
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-3 g-3">
              <div class="col ">
                <div class="card pb-lg-4 pb-md-5 pb-xl-4">
                  <div class="card-body">
                    <div class="justify-content-between align-items-center">
                      ...
                      <h5 class="mt-3 mb-3" style="color: #00763A;">Program Billingual (Arab dan Inggris)</h5>
                      <h6 class="mt-2 pb-md-1 d-none d-md-block mb-lg-4 pb-xl-4 mb-xl-3 pb-lg-3">Pengembangan kemampuan bahasa Arab dan bahsa Inggris yang intensif di Sekolah.</h6>
                      <h6 class="mt-2 pb-md-1 d-block d-md-none">Pengembangan kemampuan bahasa Arab dan bahsa Inggris yang intensif di Sekolah.</h6>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col">
                <div class="card pb-lg-2 pb-md-2 pb-xl-3" >
                  <div class="card-body">
                    <div class="justify-content-between align-items-center">
                      <svg class="mt-3" width="71" height="71" viewBox="0 0 71 71" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                      ...
                      <h5 class="mt-3 mb-3 mb-md-4" style="color: #00763A;">Pembinaan 4 Jam</h5>
                      <h6 class="mt-2 pb-xl-3 mb-xl-3 pb-md-1 ">Siswa akan mendapatkan pendampingan bersama guru-guru berpengalaman selama pembelajaran berlangsung di sekolah maupun diluar sekolah.</h6>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card pb-lg-5 pb-md-4 pb-xl-5" >
                  <div class="card-body">
                    <div class="justify-content-between align-items-center">
                      ...
                      <h5 class="mt-3 mb-3 mb-md-4 " style="color: #00763A;">Generasi Terwujud</h5>
                      <h6 class="mt-2 pb-xl-5 pb-lg-4 mb-xl-2 pb-md-5 mb-md-3 mb-md-2">Terwujudnya generasi yang unggul menuju terbentuknya khaira ummah. </h6>
                    </div>
                  </div>
                </div>
              </div>
     ...
     <div class="card text-bg-dark text-center mt-5 position-relative">
            ...
            <div class="card-img-overlay d-flex flex-column align-items-center justify-content-center">
                ...
                <h5 class="card-text mb-4 d-none d-md-block">PAUD Ar-Risalah siap membantu para orang tua untuk menyelamatkan “Usia Emas” putra putrinya</h5>
                <!-- Mobile View -->
                <h6 class="card-title mb-1 d-block d-md-none">Pendaftaran Peserta Didik Baru</h6>
                <small class="card-text mb-1 d-block d-md-none">PAUD Ar-Risalah siap membantu para orang tua untuk menyelamatkan “Usia Emas” putra putrinya</small>
