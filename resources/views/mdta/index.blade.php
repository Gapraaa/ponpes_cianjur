...
<html lang="en">
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(53, 102, 53, 0.342); /* Green with 75% transparency */
  z-index: 1; /* Ensures the overlay is above the image but below the captions */
}
    ...
    <main>
      <div id="carouselExampleCaptions" class="carousel slide mt-5">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="{{ asset (asset/img/homemdta1.png)}}" class="d-block w-100" alt="...">
            <div class="overlay"></div>
            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
              <h3>MDTA Ar-Risalah</h3>
              <h5>Kreatif, Inovatif, Dinamis dan Berwawasan Luas</h5>
            </div>
          </div>
          <div class="carousel-item">
            <img src="{{ asset (asset/img/homemdta2.jpg)}}" class="d-block w-100" alt="...">
            <div class="overlay"></div>
            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
              <h3>MDTA Ar-Risalah</h3>
              <h5>Kreatif, Inovatif, Dinamis dan Berwawasan Luas</h5>
          ...
          <div class="carousel-item">
            <img src="{{ asset (asset/img/homemdta3.jpg)}}" class="d-block w-100" alt="...">
            <div class="overlay"></div>
            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
              <h3>MDTA Ar-Risalah</h3>
              <h5>Kreatif, Inovatif, Dinamis dan Berwawasan Luas</h5>
      ...
      <div class="jumbo d-flex justify-content-around" style="background-color: #E2E2E2; padding: 2rem 1rem;">
        <div class="text-center">
          <h4><span style="color: #00763A;">Informasi &</span> Pendaftaran Murid Baru</h4>
          <h4 style="color: #00763A;">Tahun Ajaran 2024/2025</h4>
          <p>MDTA Ar-Risalah siap memenuhi kebutuhan masyarakat akan tambahan pendidikan agama<br>Islam terutama bagi siswa yang belajar di Sekolah Dasar (SD).</p>
      </div>
      <div class="">
                ...
                <div class="card-body">
                  <div class="justify-content-between align-items-center">
                    <svg width="81" height="81" viewBox="0 0 81 81" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M70.875 33.75H64.125V13.5H67.5V6.75H13.5V13.5H16.875V33.75H10.125C9.22989 33.75 8.37145 34.1056 7.73851 34.7385C7.10558 35.3715 6.75 36.2299 6.75 37.125V67.5H74.25V37.125C74.25 36.2299 73.8944 35.3715 73.2615 34.7385C72.6286 34.1056 71.7701 33.75 70.875 33.75ZM47.25 60.75V47.25H33.75V60.75H23.625V13.5H57.375V60.75H47.25Z" fill="#1E1E1E"/>
                      <path d="M30.375 20.25H37.125V27H30.375V20.25ZM43.875 20.25H50.625V27H43.875V20.25ZM30.375 33.75H37.125V40.5H30.375V33.75ZM43.875 33.75H50.625V40.5H43.875V33.75Z" fill="#1E1E1E"/>
                      </svg>  
                    <h3>Visi</h3>
                    <p>Terciptanya peserta didik cerdas,<br>aktif, kreatif dan inovatif serta<br>bertaqwa kepada Tuhan Yang Maha Esa.</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="card-body">
                  <div class="justify-content-between align-items-center">
                    <svg width="71" height="81" viewBox="0 0 71 81" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <h3>Misi</h3>
                    <p>Mendidik dan mengembangkan generasi<br>mukmin-muslim yang berbudi tinggi, berbadan<br>sehat, berpengeta-huan luas, dan berpikiran bebas, serta berkhidmat kepada semua orang.</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="card-body">
                  <div class="justify-content-between align-items-center">
                    <svg width="95" height="81" viewBox="0 0 95 81" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <h3>Tujuan</h3>
                    <p>Lahirnya siswa intelek yang memiliki<br>keseimbangan zikir sekaligus pikir dan<br>terwujudnya kepribadian yang beriman dan<br>bertakwa kepada Allah SWT.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="card text-bg-dark mt-4">
        ...
        <div class="card-img-overlay">
          ...
          <div class="card col-md-6 float-md-end mb-3 ms-md-3 m-5" style="width: 30rem;">
            <img src="{{ asset (asset/img/selayang pandang mdta.jpg)}}" class="card-img-top" alt="..." >
          </div>
          <small class="card-text-center col-md-5 float-md-end mb-3 ms-md-6 m-5">Madrasah Diniyah Takmiliyah Awaliyah (MDTA) adalah satuan pendidikan <br> keagamaan Islam bersifat non formal yang menyelenggarakan pendidikan <br> tingkat dasar setara SD/sederajat dengan masa belajar 4 (empat) tahun <br> dan jumlah jam belajar 18 (delapan belas) jam per minggu.
            Program <br>  Madrasah Diniyah Takmiliyah Awaliyah (MDTA) Al Ar-Risalah menggunakan <br> kurikulum yang ditetapkan Kementrian Agama dan Kurikulum Tingkat <br> Satuan Pendidikan (KTSP) diantaranya meliputi; Qur’an Hadits, Akidah Akhlak, <br> Fiqih, Sejarah Kebudayaan Islam, Bahasa Arab dan Praktek Ibadah. <br> Pembelajaran dilakukan dengan cara sistem praktek. Santri diharapkan <br> mampu mengaplikasikan materi yang disampaikan oleh guru. Waktu <br> kegiatan dilakukan dari jam 14.00 s.d. 16.30 WIB.</small>
        </div>
      </div>
      <div class="countainer text-center mt-4">
        <h3><span style="color: #00763A;">Mengapa Memilih</span> MDTA Ar-Risalah Syafi’iyyah?</h3>
        <div class="container mt-4">
              ...
              <div class="card" style="height: 20rem;">
                <div class="card-body">
                  <div class="justify-content-between align-items-center">
                    ...
                    <h3 class="mt-2"  style="color: #00763A;">Pendidikan Berbasis Agama</h3>
                    <p class="mt-2">Memberikan pendidikan yang berbasis pada ajaran Islam, termasuk pembelajaran Al-Quran, hadis, dan nilai-nilai Islam.</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="card-body">
                  <div class="justify-content-between align-items-center">
                    <svg width="71" height="71" viewBox="0 0 71 71" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <mask id="mask0_38_17" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="4" y="10" width="63" height="57">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M35.5 11.8334L65.0833 31.0625V65.0834H5.91667V31.0625L35.5 11.8334Z" fill="white" stroke="white" stroke-width="3.25" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M29.5833 65.0834V34.0209L17.75 41.4167V65.0834M41.4167 65.0834V34.0209L53.25 41.4167V65.0834" stroke="black" stroke-width="3.25" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M60.6458 65.0834H11.8333" stroke="white" stroke-width="3.25" stroke-linecap="round" stroke-linejoin="round"/>
                      </mask>
            ...
            <div class="col">
              <div class="card"  style="height: 20rem;">
                <div class="card-body">
                  <div class="justify-content-between align-items-center">
                    <svg width="71" height="71" viewBox="0 0 71 71" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M28.2521 49.9594L53.324 24.8875C53.9156 24.2958 54.6059 24 55.3948 24C56.1837 24 56.874 24.2958 57.4656 24.8875C58.0573 25.4792 58.3531 26.1823 58.3531 26.9968C58.3531 27.8113 58.0573 28.5134 57.4656 29.1031L30.3229 56.3198C29.7313 56.9115 29.041 57.2073 28.2521 57.2073C27.4632 57.2073 26.7729 56.9115 26.1813 56.3198L13.4604 43.599C12.8688 43.0073 12.5848 42.3052 12.6084 41.4926C12.6321 40.6801 12.9407 39.977 13.5344 39.3833C14.128 38.7897 14.8311 38.4939 15.6437 38.4958C16.4562 38.4978 17.1583 38.7936 17.75 39.3833L28.2521 49.9594Z" fill="#00763A"/>
                      <path d="M28.5759 34.98L43.9218 17.6147C44.2839 17.2049 44.7064 17 45.1893 17C45.6721 17 46.0946 17.2049 46.4568 17.6147C46.8189 18.0245 47 18.5115 47 19.0756C47 19.6398 46.8189 20.1261 46.4568 20.5345L29.8434 39.3853C29.4813 39.7951 29.0588 40 28.5759 40C28.0931 40 27.6706 39.7951 27.3084 39.3853L19.5223 30.5746C19.1602 30.1648 18.9863 29.6785 19.0008 29.1157C19.0153 28.5529 19.2042 28.066 19.5676 27.6548C19.9309 27.2436 20.3613 27.0387 20.8586 27.0401C21.356 27.0415 21.7857 27.2464 22.1479 27.6548L28.5759 34.98Z" fill="#00763A"/>
                      </svg>                      
                      <h3 class="mt-2"  style="color: #00763A;">Kualitas Pendidikan</h3>
                    <p class="mt-2">menawarkan kurikulum yang seimbang antara pendidikan agama dan akademik, sehingga siswa tetap mendapatkan pendidikan yang berkualitas dan memenuhi standar nasional.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="card text-bg-dark text-center mt-4">
        ...
        <div class="card-img-overlay">
          ...
          <p class="card-text">MDTA Ar-Risalah siap memenuhi kebutuhan akan tambahan pendidikan agama Islam</p>
      ...
      <h3 class="text-center mt-3"><span class="border-bottom border-2 border-black"><span style="color: #00763A;">Dokumentasi</span> Kegiatan</span></h3>
      <div class="container">
            ...
            <div class="row">
              <div class="col-md-4 mt-3">
                <div class="card" style="margin-left: 60x;">
                  <img src="{{ asset (asset/img/kegiatan mdta 2.jpg)}}" class="card-img-top" alt="...">
                </div>
              </div>
              <div class="col-md-4 mt-3">
                <div class="card">
                  <img src="{{ asset (asset/img/kegiatan mdta 3.jpg)}}" class="card-img-top" alt="...">
                </div>
              </div>
              <div class="col-md-4 mt-3">
                <div class="card">
                  <img src="{{ asset (asset/img/kegiatan mdta.jpg)}}" class="card-img-top" alt="...">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="row">
              ...
              <div class="col mt-3">
                  <img src="{{ asset (asset/img/logounivibnkhaldun.jpg)}}" class="card-img-top" alt="..." style="max-width: 200px; padding-left: 50px;">
              </div>
              <div class="col mt-3">
