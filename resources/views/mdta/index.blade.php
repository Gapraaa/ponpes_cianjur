       ...
       <div id="carouselExampleCaptions" class="carousel slide mt-5">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active position-relative">
                    <img src="{{ asset('asset/img/homemdta1.png') }}" class="d-block w-100 img-fluid" alt="...">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center pt-5 mb-lg-5 mt-lg-5 d-none d-md-block">
                        <h2 class="text-center mt-lg-5">MDTA Ar-Risalah</h2>
                        <h5 class="text-center mb-lg-5">Kreatif, Inovatif, Dinamis, Berwawasan Luas</h5>
                    </div>
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center d-block d-md-none">
                        <small class="text-center "><strong> MDTA Ar-Risalah</strong></small>
                        <small class="text-center"><strong> Kreatif, Inovatif, Dinamis, Berwawasan Luas</strong></small>
                    </div>
                </div>
                <div class="carousel-item position-relative">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center d-block d-md-none">
                        <h6 class="text-center ">MDTA Ar-Risalah</h6>
                        <h6 class="text-center ">Kreatif, Inovatif, Dinamis, Berwawasan Luas</h6>
                    </div>
                </div>
                <div class="carousel-item position-relative">
                    <img src="{{ asset('asset/img/homemdta1.png') }}" class="d-block w-100 img-fluid" alt="...">
        ...
        <div class="jumbo d-flex justify-content-around" style="background-color: #E2E2E2; padding: 2rem 1rem;">
            <div class="text-center d-none d-md-block">
                ...
                <p>MDTA Ar-Risalah siap memenuhi kebutuhan  masyarakat akan tambahan <br> pendidikan agama Islam
                    terutama bagi siswa yang belajar di Sekolah Dasar </p>
            </div>
            <div class="text-center d-block d-md-none">
                ...
                <small>MDTA Ar-Risalah siap memenuhi kebutuhan <br> masyarakat akan tambahan pendidikan <br> agama Islam
                    terutama bagi siswa yang belajar di Sekolah Dasar (SD).
                    ummah</small>
            </div>
      ...
      <hr class="col-1 mx-auto border border-dark opacity-100 border-2 mt-4">
        ...
        <div class="card text-bg-dark mt-lg-4 mx-lg-auto">
            <div class="position-relative">
                ...
                <img src="{{ asset('asset/img/homebg2mbl.jpg') }}" class="card-img d-block d-sm-none" alt="Extra-small screen view">
...
Program pembelajaran Madrasah Diniyah Takmiliyah Awaliyah (MDTA) Al Ar-Risalah menggunakan kurikulum yang ditetapkan Kementrian Agama dan Kurikulum Tingkat Satuan Pendidikan (KTSP) diantaranya meliputi; Qur’an Hadits, Akidah Akhlak, Fiqih, Sejarah Kebudayaan Islam, Bahasa Arab dan Praktek Ibadah. Pembelajaran dilakukan dengan cara sistem praktek. Santri diharapkan mampu mengaplikasikan materi yang disampaikan oleh guru. Waktu kegiatan dilakukan dari jam 14.00 s.d. 16.30 WIB
        ...
        <div class="countainer text-center mt-5">
            ...
            <div class="col-10 col-lg-12 col-md-12 g-5 mx-auto container mt-5">
                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-3 g-3">
                    <div class="col">
                        <div class="card pb-md-5 pb-lg-5">
                            <div class="card-body">
                                <div class="justify-content-between align-items-center">
                                    <svg width="71" height="81" viewBox="0 0 71 81" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h5 class="mt-2 mb-3" style="color: #00763A;">Pendidikan Berbasis Agama</h5>
                                    <h6 class="mt-2 pb-lg-4">Memberikan pendidikan yang berbasis pada ajaran Islam, termasuk
                    ...
                    <div class="col">
                        <div class="card pb-md-5 pb-xl-5">
                            <div class="card-body">
                                <div class="justify-content-between align-items-center">
                                    ...
                                    <h5 class="mt-2 mb-3" style="color: #00763A;">Tahfizh Hadist</h5>
                                    <h6 class="mt-2 pb-xl-3 pb-md-3">Program tahfizh hadist merupakan kunci memahami Alquran, jalan
                    ...
                    <div class="col">
                        <div class="card pb-xl-4 pb-lg-4 pb-md-2">
                            <div class="card-body">
                                <div class="justify-content-between align-items-center">
                                    <svg width="71" height="71" viewBox="0 0 71 71" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h5 class="mt-2 mb-3" style="color: #00763A;">Kualitas Pendidikan</h5>
                                    <h6 class="mt-2 pb-lg-3 pb-xl-3 ">menawarkan kurikulum yang seimbang antara pendidikan agama dan
        ...
        <div class="card text-bg-dark text-center mt-5 position-relative">
            ...
            <div class="card-img-overlay d-flex flex-column align-items-center justify-content-center">
                ...
                <h5 class="card-text mb-4 d-none d-md-block">MDTA Ar-Risalah siap memenuhi kebutuhan akan tambahan pendidikan agama Islam</h5>
                <!-- Mobile View -->
                <h6 class="card-title mb-1 d-block d-md-none">Pendaftaran Peserta Didik Baru</h6>
                <small class="card-text mb-1 d-block d-md-none">MDTA Ar-Risalah siap memenuhi kebutuhan akan tambahan pendidikan agama Islam</small>
